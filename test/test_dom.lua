...
local textarea = document:create_element "textarea" :append "テキストエリア"
textarea
  :set_attribute("id", "output")
  :set_attribute("rows", 8)
  :set_attribute("cols", 80)
...
for i = 1, 240 do
  ...
  textarea:set_attribute("style", ("background-color: #%02X%02X%02X; color: #FF%02X%02X"):format(y, y, y, z, z))
  coroutine.yield()
end
